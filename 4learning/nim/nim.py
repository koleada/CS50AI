...
class NimAI:
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        """
        q_item: tuple = (tuple(state), action)
        self.q[q_item] = old_q + self.alpha * ((reward + future_rewards) - old_q)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        for action in actions:
            if self.get_q_value(state, action) > min:
                min = self.get_q_value(state, action)
                best_move = action
